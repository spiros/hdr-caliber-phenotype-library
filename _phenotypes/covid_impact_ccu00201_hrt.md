...
codelists: 
    - covid_impact_ccu00201_hrt_England_BNF.csv
...
#### England primary care EHR: HRT 
{% include csv.html csvdata=site.data.codelists.covid_impact_ccu00201_hrt_England_BNF %}
