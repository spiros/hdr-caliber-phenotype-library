---
layout: phenotype
title: CCU002_01 Thrombocytopenia
name: CCU002_01 Thrombocytopenia
phenotype_id: 95vpCQMJ7ECKPYeaxP2v2t
...
codelists: 
    - covid_impact_ccu00201_thrombocytopenia_England_ICD10.csv
    - covid_impact_ccu00201_TCP_covariate_only_England_SNOMEDCT.csv
    - covid_impact_ccu00201_TCP_Wales_Read2.csv
...
#### England hospitalization EHR: Thrombocytopenia diagnosis 
{% include csv.html csvdata=site.data.codelists.covid_impact_ccu00201_thrombocytopenia_England_ICD10 %}
#### England primary care EHR: Thrombocytopenia (as covariate) diagnosis 
{% include csv.html csvdata=site.data.codelists.covid_impact_ccu00201_TCP_covariate_only_England_SNOMEDCT %}
#### Wales primary care EHR: Thrombocytopenia diagnosis 
{% include csv.html csvdata=site.data.codelists.covid_impact_ccu00201_TCP_Wales_Read2 %}
