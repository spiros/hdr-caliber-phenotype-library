...
codelists:
    - covid_impact_ccu000_England_obesity_ICD10.csv
    - covid_impact_ccu000_England_obesity_SNOMEDCT.csv
...
#### England hospitalization EHR: Obesity diagnosis 
{% include csv.html csvdata=site.data.codelists.covid_impact_ccu000_England_obesity_ICD10 %}
#### England primary care EHR: Obesity diagnosis 
{% include csv.html csvdata=site.data.codelists.covid_impact_ccu000_England_obesity_SNOMEDCT %}
