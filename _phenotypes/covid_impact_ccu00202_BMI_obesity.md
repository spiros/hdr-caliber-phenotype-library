...
codelists: 
    - covid_impact_ccu00202_BMI_obesity_England_SNOMEDCT.csv
...
#### England primary care EHR: Obesity 
{% include csv.html csvdata=site.data.codelists.covid_impact_ccu00202_BMI_obesity_England_SNOMEDCT %}
