...
codelists: 
    - covid_impact_ccu00201_cocp_England_BNF.csv
...
#### England primary care EHR: Contraceptive medication 
{% include csv.html csvdata=site.data.codelists.covid_impact_ccu00201_cocp_England_BNF %}
