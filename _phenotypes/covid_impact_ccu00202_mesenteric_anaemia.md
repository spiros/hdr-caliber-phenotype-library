...
codelists: 
    - covid_impact_ccu00202_mesenteric_anaemia_England_ICD10.csv
...
#### England hospitalization EHR: Mesenteric anaemia diagnosis 
{% include csv.html csvdata=site.data.codelists.covid_impact_ccu00202_mesenteric_anaemia_England_ICD10 %}
