...
clinical_terminologies:
    - Read Version 2
validation:
codelists: Kontopantelis_Hypertension_ihyFNnCDPjYig3CNKxjrCJ_Read.csv
...
{% include csv.html csvdata=site.data.codelists.Kontopantelis_Hypertension_ihyFNnCDPjYig3CNKxjrCJ_Read %}
