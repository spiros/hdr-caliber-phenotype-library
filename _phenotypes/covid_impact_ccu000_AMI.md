...
codelists:
    - covid_impact_ccu000_England_AMI_ICD10.csv
    - covid_impact_ccu000_England_AMI_SNOMEDCT.csv
...
{% include csv.html csvdata=site.data.codelists.covid_impact_ccu000_England_AMI_ICD10 %}
#### England primary care EHR: AMI diagnosis 
{% include csv.html csvdata=site.data.codelists.covid_impact_ccu000_England_AMI_SNOMEDCT %}
