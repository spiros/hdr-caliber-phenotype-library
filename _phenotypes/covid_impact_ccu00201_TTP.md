...
codelists: 
    - covid_impact_ccu00201_TTP_England_ICD10.csv
...
#### England hospitalization EHR: Thrombotic microangiopathy 
{% include csv.html csvdata=site.data.codelists.covid_impact_ccu00201_TTP_England_ICD10 %}
