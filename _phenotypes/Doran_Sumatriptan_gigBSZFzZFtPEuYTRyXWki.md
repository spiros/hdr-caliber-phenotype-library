...
clinical_terminologies:
    - Read Version 2
validation:
codelists: Doran_Sumatriptan_gigBSZFzZFtPEuYTRyXWki_GPRDProductCode.csv
...
{% include csv.html csvdata=site.data.codelists.Doran_Sumatriptan_gigBSZFzZFtPEuYTRyXWki_GPRDProductCode %}
