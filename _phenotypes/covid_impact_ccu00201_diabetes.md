...
codelists: 
    - covid_impact_ccu00201_diabetes_England_SNOMEDCT.csv
    - covid_impact_ccu00201_diabetes_England_ICD10.csv
    - covid_impact_ccu00201_diabetes_drugs_England_DMD.csv
...
#### England primary care EHR: Diabetes 
{% include csv.html csvdata=site.data.codelists.covid_impact_ccu00201_diabetes_England_SNOMEDCT %}
#### England hospitalization EHR: Diabetes 
{% include csv.html csvdata=site.data.codelists.covid_impact_ccu00201_diabetes_England_ICD10 %}
#### England primary care EHR: Diabetes medication 
{% include csv.html csvdata=site.data.codelists.covid_impact_ccu00201_diabetes_drugs_England_DMD %}
