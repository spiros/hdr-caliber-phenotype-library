---
layout: phenotype
title: CCU002_02 Acute Myocardial Infarction (AMI)
name: CCU002_02 Acute Myocardial Infarction (AMI)
phenotype_id: m4dgeHbYTHCXKJbzJ2qWwf
...
codelists: 
    - covid_impact_ccu00202_AMI_England_ICD10.csv
    - covid_impact_ccu00202_AMI_England_SNOMEDCT.csv
...
#### England hospitalization EHR: MI diagnosis 
{% include csv.html csvdata=site.data.codelists.covid_impact_ccu00202_AMI_England_ICD10 %}
#### England primary care EHR: MI diagnosis 
{% include csv.html csvdata=site.data.codelists.covid_impact_ccu00202_AMI_England_SNOMEDCT %}
