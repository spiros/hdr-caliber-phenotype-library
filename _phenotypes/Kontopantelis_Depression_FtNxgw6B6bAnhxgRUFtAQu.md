...
clinical_terminologies:
    - Read Version 2
validation:
codelists: Kontopantelis_Depression_FtNxgw6B6bAnhxgRUFtAQu_Read.csv
...
{% include csv.html csvdata=site.data.codelists.Kontopantelis_Depression_FtNxgw6B6bAnhxgRUFtAQu_Read %}
