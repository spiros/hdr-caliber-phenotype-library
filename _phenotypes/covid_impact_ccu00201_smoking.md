...
codelists: 
    - covid_impact_ccu00201_Smoker_Ex_England_SNOMEDCT.csv
    - covid_impact_ccu00201_Smoker_current_England_SNOMEDCT.csv
    - covid_impact_ccu00201_SMOKING_Wales_Read2.csv
...
#### England primary care EHR: Ex smoker 
{% include csv.html csvdata=site.data.codelists.covid_impact_ccu00201_Smoker_Ex_England_SNOMEDCT %}
#### England primary care EHR: Current smoker 
{% include csv.html csvdata=site.data.codelists.covid_impact_ccu00201_Smoker_current_England_SNOMEDCT %}
#### Wales primary care EHR: Smoking status 
{% include csv.html csvdata=site.data.codelists.covid_impact_ccu00201_SMOKING_Wales_Read2 %}
