...
clinical_terminologies:
    - Read Version 2
validation:
codelists: Kontopantelis_Osteoarthritis_LaqHGP9d4TaFKk5sqZRZaV_Read.csv
...
{% include csv.html csvdata=site.data.codelists.Kontopantelis_Osteoarthritis_LaqHGP9d4TaFKk5sqZRZaV_Read %}
