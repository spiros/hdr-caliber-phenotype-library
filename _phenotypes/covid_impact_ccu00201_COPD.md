---
layout: phenotype
title: CCU002_01 Chronic obstructive pulmonary disease (COPD)
name: CCU002_01 Chronic obstructive pulmonary disease (COPD)
phenotype_id: 85bcu8VnCaDEH5BUsnWq7q
...
codelists: 
    - covid_impact_ccu00201_COPD_England_ICD10.csv
    - covid_impact_ccu00201_COPD_England_SNOMEDCT.csv
    - covid_impact_ccu00201_COPD_Wales_Read2.csv
...
#### England hospitalization EHR: COPD diagnosis 
{% include csv.html csvdata=site.data.codelists.covid_impact_ccu00201_COPD_England_ICD10 %}
#### England primary care EHR: COPD diagnosis 
{% include csv.html csvdata=site.data.codelists.covid_impact_ccu00201_COPD_England_SNOMEDCT %}
#### Wales primary care EHR: COPD diagnosis 
{% include csv.html csvdata=site.data.codelists.covid_impact_ccu00201_COPD_Wales_Read2 %}
