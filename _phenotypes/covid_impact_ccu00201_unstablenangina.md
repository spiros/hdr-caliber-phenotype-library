...
codelists: 
    - covid_impact_ccu00201_unstable_angina_England_SNOMEDCT.csv
    - covid_impact_ccu00201_unstable_angina_England_ICD10.csv
    - covid_impact_ccu00201_UNSTABLE_ANGINA_Wales_Read2.csv
...
#### England primary care EHR: Unstable angina diagnosis 
{% include csv.html csvdata=site.data.codelists.covid_impact_ccu00201_unstable_angina_England_SNOMEDCT %}
#### England hospitalization EHR: Unstable angina diagnosis 
{% include csv.html csvdata=site.data.codelists.covid_impact_ccu00201_unstable_angina_England_ICD10 %}
#### Wales primary care EHR: Unstable angina diagnosis 
{% include csv.html csvdata=site.data.codelists.covid_impact_ccu00201_UNSTABLE_ANGINA_Wales_Read2 %}
