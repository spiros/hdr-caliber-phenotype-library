...
codelists: 
    - covid_impact_ccu00201_GDPPR_confirmed_COVID_England_SNOMEDCT.csv
...
{% include csv.html csvdata=site.data.codelists.covid_impact_ccu00201_GDPPR_confirmed_COVID_England_SNOMEDCT %}
