...
clinical_terminologies:
    - GPRD Product Code
validation:
codelists: Doran_Bisphosphonates_ewhSVR5ixVz2UgZvBt8aTS_GPRDProductCode.csv
...
{% include csv.html csvdata=site.data.codelists.Doran_Bisphosphonates_ewhSVR5ixVz2UgZvBt8aTS_GPRDProductCode %}
