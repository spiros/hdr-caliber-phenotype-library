...
clinical_terminologies:
    - Read Version 2
validation:
codelists: Doran_Pneumococcalvaccine_hnDDT4kpapkzXsLHroVhUB_GPRDProductCode.csv
...
{% include csv.html csvdata=site.data.codelists.Doran_Pneumococcalvaccine_hnDDT4kpapkzXsLHroVhUB_GPRDProductCode %}
