...
codelists: 
    - covid_impact_ccu00202_DVT_DVT_England_ICD10.csv
    - covid_impact_ccu00202_DVT_ICVT_England_ICD10.csv
    - covid_impact_ccu00202_DVT_ICVT_England_SNOMEDCT.csv
...
#### England hospitalization EHR: Deep Vein Thrombosis diagnosis 
{% include csv.html csvdata=site.data.codelists.covid_impact_ccu00202_DVT_DVT_England_ICD10 %}
#### England hospitalization EHR: Cerebral venous thrombosis 
{% include csv.html csvdata=site.data.codelists.covid_impact_ccu00202_DVT_ICVT_England_ICD10 %}
#### England primary care EHR: Cerebral venous thrombosis 
{% include csv.html csvdata=site.data.codelists.covid_impact_ccu00202_DVT_ICVT_England_SNOMEDCT %}
