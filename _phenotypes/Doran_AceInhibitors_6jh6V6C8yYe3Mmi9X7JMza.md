...
clinical_terminologies:
    - GPRD product Code
validation:
codelists: Doran_AceInhibitors_6jh6V6C8yYe3Mmi9X7JMza_GPRDProductCode.csv
...
{% include csv.html csvdata=site.data.codelists.Doran_AceInhibitors_6jh6V6C8yYe3Mmi9X7JMza_GPRDProductCode %}
