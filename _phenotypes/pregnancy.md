...
layout: phenotype
title: Pregnancy
phenotype_id: gsACzuiX5NtJfpNjQJ7bg3
name: Pregnancy
...
codelists:
    - caliber_pregnancy_gsACzuiX5NtJfpNjQJ7bg3_Read2.csv
...
{% include csv.html csvdata=site.data.codelists.caliber_pregnancy_gsACzuiX5NtJfpNjQJ7bg3_Read2 %}
