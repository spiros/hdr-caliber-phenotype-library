...
clinical_terminologies:
    - Read Version 2
validation:
codelists: Kontopantelis_Heartfailure_YA5hCoYXa6naXAV6XH7wSr_Read.csv
...
{% include csv.html csvdata=site.data.codelists.Kontopantelis_Heartfailure_YA5hCoYXa6naXAV6XH7wSr_Read %}
