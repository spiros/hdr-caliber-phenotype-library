...
codelists: 
    - covid_impact_ccu00202_pad_England_SNOMEDCT.csv
...
#### England primary care EHR: Peripheral arterial disease diagnosis 
{% include csv.html csvdata=site.data.codelists.covid_impact_ccu00202_pad_England_SNOMEDCT %}
