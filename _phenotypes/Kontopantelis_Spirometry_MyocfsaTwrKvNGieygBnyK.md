...
clinical_terminologies:
    - Read Version 2
validation:
codelists: Kontopantelis_Spirometry_MyocfsaTwrKvNGieygBnyK_Read.csv
...
{% include csv.html csvdata=site.data.codelists.Kontopantelis_Spirometry_MyocfsaTwrKvNGieygBnyK_Read %}
