...
codelists: 
    - covid_impact_ccu00202_VT_England_ICD10.csv
...
#### England hospitalization EHR: Venous Thrombosis diagnosis 
{% include csv.html csvdata=site.data.codelists.covid_impact_ccu00202_VT_England_ICD10 %}
