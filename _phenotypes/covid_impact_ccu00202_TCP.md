...
codelists: 
    - covid_impact_ccu00202_TCP_England_SNOMEDCT.csv
    - covid_impact_ccu00202_TCP_England_ICD10.csv
...
#### England primary care EHR: Thrombocytopenia diagnosis 
{% include csv.html csvdata=site.data.codelists.covid_impact_ccu00202_TCP_England_SNOMEDCT %}
#### England hospitalization EHR: Thrombocytopenia diagnosis 
{% include csv.html csvdata=site.data.codelists.covid_impact_ccu00202_TCP_England_ICD10 %}
