...
codelists: 
    - covid_impact_ccu00202_COPD_England_ICD10.csv
    - covid_impact_ccu00202_COPD_England_SNOMEDCT.csv
...
{% include csv.html csvdata=site.data.codelists.covid_impact_ccu00202_COPD_England_ICD10 %}
#### England primary care EHR: COPD diagnosis 
{% include csv.html csvdata=site.data.codelists.covid_impact_ccu00202_COPD_England_SNOMEDCT %}
