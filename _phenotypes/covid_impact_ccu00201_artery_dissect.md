...
codelists: 
    - covid_impact_ccu00201_artery_dissect_England_ICD10.csv
    - covid_impact_ccu00201_ARTERY_DISSECT_Wales_Read2.csv
...
#### England hospitalization EHR: Dissection of artery 
{% include csv.html csvdata=site.data.codelists.covid_impact_ccu00201_artery_dissect_England_ICD10 %}
#### Wales primary care EHR: Dissection of artery 
{% include csv.html csvdata=site.data.codelists.covid_impact_ccu00201_ARTERY_DISSECT_Wales_Read2 %}
