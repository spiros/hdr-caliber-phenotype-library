...
codelists: 
    - covid_impact_ccu00201_AMI_England_ICD10.csv
    - covid_impact_ccu00201_AMI_England_SNOMEDCT.csv
    - covid_impact_ccu00201_AMI_covariate_only_England_ICD10.csv
    - covid_impact_ccu00201_AMI_Wales_Read2.csv
...
#### England hospitalization EHR: AMI diagnosis 
{% include csv.html csvdata=site.data.codelists.covid_impact_ccu00201_AMI_England_ICD10 %}
#### England primary care EHR: AMI diagnosis 
{% include csv.html csvdata=site.data.codelists.covid_impact_ccu00201_AMI_England_SNOMEDCT %}
#### England hospitalization EHR: AMI (as covariate) diagnosis 
{% include csv.html csvdata=site.data.codelists.covid_impact_ccu00201_AMI_covariate_only_England_ICD10 %}
#### Wales primary care EHR: AMI diagnosis 
{% include csv.html csvdata=site.data.codelists.covid_impact_ccu00201_AMI_Wales_Read2 %}
