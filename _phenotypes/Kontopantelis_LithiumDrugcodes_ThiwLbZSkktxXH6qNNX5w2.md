...
clinical_terminologies:
    ...
    - OXMIS
validation:
codelists: Kontopantelis_LithiumDrugcodes_ThiwLbZSkktxXH6qNNX5w2_CPRD_product_code.csv
...
{% include csv.html csvdata=site.data.codelists.Kontopantelis_LithiumDrugcodes_ThiwLbZSkktxXH6qNNX5w2_CPRD_product_code %}
