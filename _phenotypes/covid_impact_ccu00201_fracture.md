...
codelists: 
    - covid_impact_ccu00201_fracture_England_ICD10.csv
...
#### England hospitalization EHR: Lower limb fracture 
{% include csv.html csvdata=site.data.codelists.covid_impact_ccu00201_fracture_England_ICD10 %}
