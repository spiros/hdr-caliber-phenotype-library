...
codelists: 
    - covid_impact_ccu00202_SCD_England_SNOMEDCT.csv
    - covid_impact_ccu00202_SCD_England_ICD10.csv
...
#### England primary care EHR: Sudden Cardiac Death diagnosis 
{% include csv.html csvdata=site.data.codelists.covid_impact_ccu00202_SCD_England_SNOMEDCT %}
#### England hospitalization EHR: Sudden Cardiac Death diagnosis 
{% include csv.html csvdata=site.data.codelists.covid_impact_ccu00202_SCD_England_ICD10 %}
