...
codelists: 
    - covid_impact_ccu00202_AF_England_SNOMEDCT.csv
    - covid_impact_ccu00202_AF_England_ICD10.csv
...
#### England primary care EHR: AF diagnosis 
{% include csv.html csvdata=site.data.codelists.covid_impact_ccu00202_AF_England_SNOMEDCT %}
#### England hospitalization EHR: AF diagnosis 
{% include csv.html csvdata=site.data.codelists.covid_impact_ccu00202_AF_England_ICD10 %}
