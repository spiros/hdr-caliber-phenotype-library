...
clinical_terminologies:
    - Read Version 2
validation:
codelists: Kontopantelis_Osteoporosis_Uw8BnkHcAhWhNMN5UPHoqS_Read.csv
...
{% include csv.html csvdata=site.data.codelists.Kontopantelis_Osteoporosis_Uw8BnkHcAhWhNMN5UPHoqS_Read %}
