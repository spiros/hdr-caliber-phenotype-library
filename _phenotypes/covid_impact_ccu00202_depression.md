...
codelists: 
    - covid_impact_ccu00202_depression_England_ICD10.csv
    - covid_impact_ccu00202_depression_England_SNOMEDCT.csv
...
{% include csv.html csvdata=site.data.codelists.covid_impact_ccu00202_depression_England_ICD10 %}
#### England primary care EHR: Depression diagnosis 
{% include csv.html csvdata=site.data.codelists.covid_impact_ccu00202_depression_England_SNOMEDCT %}
