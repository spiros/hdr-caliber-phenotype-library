...
codelists: 
    - covid_impact_ccu00201_pregnancy_and_birth_England_SNOMEDCT.csv
...
#### England primary care EHR: Pregnancy 
{% include csv.html csvdata=site.data.codelists.covid_impact_ccu00201_pregnancy_and_birth_England_SNOMEDCT %}
