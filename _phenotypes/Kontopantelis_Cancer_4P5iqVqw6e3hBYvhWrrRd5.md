...
clinical_terminologies:
    - Read Version 2
validation:
codelists: Kontopantelis_Cancer_4P5iqVqw6e3hBYvhWrrRd5_Read.csv
...
{% include csv.html csvdata=site.data.codelists.Kontopantelis_Cancer_4P5iqVqw6e3hBYvhWrrRd5_Read %}
